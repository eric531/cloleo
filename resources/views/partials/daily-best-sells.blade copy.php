                    ...
                    <div class="product-cart-wrap">
                        <div class="product-img-action-wrap">
                            ...
                            <div class="product-action-1">
                                ...
                                <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="{{ route('wishlist.add', $product->id) }}">
                                    <i class="fi-rs-heart"></i>
                                </a>
                                <a aria-label="Compare" class="action-btn small hover-up" href="{{ route('compare.add', $product->id) }}">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <a href="{{ route('cart.add', $product->id) }}" class="btn w-100 hover-up">
                                <i class="fi-rs-shopping-cart mr-5"></i>Ajouter au panier
                            </a>
                        </div>
                    </div>
                    @endforeach
