            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-4 card">
                        ...
                        <div class="card-body">
                            <form id="productForm" action="{{ route('admin.pubs.edit', $pub->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Titre de la pub</label>
                                    <input type="text" value="{{  $pub->name }}" name="name" placeholder="Type here" class="form-control" id="product_name" />
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Description</label>
                                    <textarea placeholder="Type here" value='{{ $pub->description }}' name="description" class="form-control" rows="4"></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-12 ">
                                            ...
                                            <div class="row gx-2">
                                                <input placeholder="Ex: http://127.0.0.1:8000/views/products/5" value="{{  $pub->link }}" name="link" type="text" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-4 card">
                        ...
                        <div class="card-body">
                            <div class="input-upload">
                                <img src="{{ $pub->image ? asset($pub->image) : asset('/admin/assets/imgs/placeholder.jpg') }} alt="Image preview" id="imagePreview" />
...
@endsection
    ...
    document.getElementById('productForm').addEventListener('submit', function(e) {
        ...
        fetch('{{ route('admin.pubs.edit', $pub->id) }}', {
            method: 'POST',
            headers: {
