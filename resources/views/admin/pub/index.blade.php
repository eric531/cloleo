...
<section class="content-main">
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Pubs</h2>
            {{-- <p>Lorem ipsum dolor sit amet.</p> --}}
        </div>
        <div>
            <a href="#" class="rounded btn btn-light font-md">Export</a>
            <a href="#" class="rounded btn btn-light font-md">Import</a>
            <a href="{{ route('admin.pubs.create') }}" class="rounded btn btn-primary btn-sm">Créer une Pub</a>
        </div>
    </div>
            ...
            <div class="row gx-3 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-5">
                ...
                <div class="col">
                    <div class="card card-product-grid">
                        <a href="#" class="img-wrap"> <img style="width: 300px; height: 200px;" src="{{ $pub->image }}" alt="Product" /> </a>
                        <div class="info-wrap">
                            <a href="#" class="title text-truncate">{{ Str::limit($pub->description, 20) }}</a>
                            <div class="mb-2 price">{{ $pub->price }}-FCFA</div>
                            <!-- price.// -->
                            <a href="{{ route('admin.pubs.edit', $pub->id) }}" class="rounded btn btn-sm font-sm btn-brand"> <i class="material-icons md-edit"></i> Edit </a>
                            <a href="{{ route('admin.pubs.destroy', $pub->id) }}" class="rounded btn btn-sm font-sm btn-light"> <i class="material-icons md-delete_forever"></i> Delete </a>
                        </div>
                    </div>
                    <!-- card-product  end// -->
                </div>
