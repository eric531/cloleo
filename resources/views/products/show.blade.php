    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="{{ route('products.index') }}">{{ $products[]->category->name??'' }}</a> <span></span> {{ $products[0]->name??'' }}
            </div>
        </div>
    </div>
                            ...
                            <div class="row mb-50 mt-30">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info pr-30 pl-30">
                                        <span class="stock-status out-stock"> {{ $product->type_product->name }} </span>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="float-left product-price primary-color">
                                                <span class="current-price text-brand">{{ $product->price }} XOF</span>
                                                <span>
                                                    <span class="save-price font-md color3 ml-15">26% Off</span>
                                                    <span class="old-price font-md ml-15">{{ $product->price_old }} XOF</span>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="short-desc mb-30">
                                            <p class="font-lg">{{ Str::words($product->description, 50) }}</p>
                                        </div>
                                        ...
                                        <div class="detail-extralink mb-50">
                                            ...
                                            <div class="product-extra-link2">
                                                ...
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                                    href="{{ route('favorites.toggle', $product->id) }}">
                                                    <i class="fi-rs-heart"></i>
                                                </a>
                                                {{-- <a aria-label="Check my cart" class="action-btn hover-up" href="">
                                                    <i class="fi-rs-cart"></i>
                                                </a> --}}
                                        ...
                                        <div id="cart-message" style="display: none; color: green; margin-top: 10px;"></div>
                                                                    ...
                                                                    <div class="desc">
                                                                        <div class="mb-10 d-flex justify-content-between">
                                                                            <div class="d-flex align-items-center">
                                                                                <span class="font-xs text-muted">December 4, 2025 at 3:12 pm </span>
                                                                            </div>
                                                                            <div class="product-rate d-inline-block">
                                    ...
                                    <div class="row related-products">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                            <div class="mb-0 product-cart-wrap hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="shop-product-right.html" tabindex="0">Dadua Camera 4K 2025EF</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span> </span>
                                                    </div>
                                                    <div class="product-price">
