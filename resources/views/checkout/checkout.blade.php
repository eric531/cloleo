        ...
        <div class="container mb-80 mt-50">
            <div class="row">
                <div class="mb-40 col-lg-8">
                    <h1 class="mb-10 heading-2">Détails Commande</h1>
                    ...
                    @auth
                        ...
                        <div class="col-lg-6 mb-sm-15 mb-lg-0 mb-md-3">
                            <div class="toggle_info">
                                <span><i class="mr-10 fi-rs-user"></i><span class="text-muted font-lg">Vous avez un compte exixtant ?</span> <a href="#loginform" data-bs-toggle="collapse" class="collapsed font-lg" aria-expanded="false">Connectez-vous</a></span>
                            </div>
                            <div class="panel-collapse collapse login_form" id="loginform">
                                <div class="panel-body">
                                    <p class="mb-30 font-sm">Si vous avez déjà effectué un achat chez nous, veuillez saisir vos coordonnées ci-dessous. Si vous êtes un nouveau client, veuillez consulter la section Facturation et livraison.</p>
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <input type="text" name="addresse" required="" placeholder="Address *">
                                </div>
                                {{-- <div class="form-group col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <input required="" type="text" name="code_postal" placeholder="Postcode / ZIP *">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input required="" type="text" name="telephone" placeholder="telephone *">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <input required="" type="text" name="entreprise" placeholder="Company Name">
                                </div>
                                <div class="form-group col-lg-6">
                            ...
                            <div class="form-group mb-30">
                                <textarea name="info" rows="5" placeholder="Additional information"></textarea>
                            </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="payment ml-30">
                        ...
                        <form action="{{ route('checkout.store') }}" method="POST">
                            @csrf
                        <button type="submit" class="btn btn-fill-out btn-block mt-30">passer une commande<i class="fi-rs-sign-out ml-15"></i></button>
                    </form>
                        {{-- <a href="#" class="btn btn-fill-out btn-block mt-30">passer une commande <i class="fi-rs-sign-out ml-15"></i></a> --}}
                    </div>
                </div>
            </div>
        </div>
